...
\usepackage[breaklinks,colorlinks=false,linkcolor=.,urlcolor=.,citecolor=teal]{hyperref}
...
\import{frontmatter}{statutoryDeclaration}
...
% \minitoc % contents of the chapter: doubt we need it
