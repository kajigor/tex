...
\begin{itemize}
  ...
  The denotational semantics of the languages disregards the order in which conjuncts are executed, and this semantics is equivalent to the operational (modulo the order in which answers are computed) see~\cite{rozplokhas2020certified} for details.}}
