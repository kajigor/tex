...
{\Large Проект для Нгуен Тхи Тху Зуен}
...
\begin{enumerate}
  \item {Реализовать синтаксический анализатор для языка с базовым синтаксисом и качественным сообщением об ошибках. }
  \begin{itemize}
    \item Сообщения об ошибке должны быть как можно более информативны.
