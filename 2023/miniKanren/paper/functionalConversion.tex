...
If no guard is present, then it searches for the first assignment (the function \lstinline{<|>} in lines~\ref{line:alt} through~\ref{line:alt2} is responsible for this), then for the match.
