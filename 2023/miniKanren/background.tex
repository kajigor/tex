...
In this section, we describe the abstract syntax of \micro version used in this paper and describe a concept of modes which was developed earlier for other logic languages.
...
\merc\footnote{Website of the \merc programming language: \url{https://mercurylang.org/}} is a modern functional-logic programming with a complicated mode system capable not only to describe a direction, but also whether the relation in the given mode is deterministic, among other things~\cite{overton2002constraint}.
...
Figure~\ref{fig:double_modded} shows examples of the normalized \micro relations with mode inferred for the forward and backward direction.
