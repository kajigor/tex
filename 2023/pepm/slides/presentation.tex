...
\begin{frame}[fragile]
  ...
  \input{fig/inverse/simple_inverse.tex}

  \todelete{We can view programs as functions. Functions can be inversed. Some inversions solve more complicated tasks than the original programs.}
...
\begin{frame}[fragile]
  \frametitle{Verifiers for Search}
\begin{center}
  \lstinline{verify :: a -> Bool}

  \lstinline{verify x $\equiv$ True}, if x -- solution
\end{center}
...
\begin{frame}[fragile]
  \frametitle{Relational Programming for Inversion}
